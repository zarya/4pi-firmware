...
Changed made for at91sam by Rudy Hardeman (Zarya), 2013
...
#define lcd_e_delay()   __asm__ __volatile__( "mov r0, r0" );
...
*************************************************************************/
#define delay(us)  _delayFourCycles( ( ( 1*(BOARD_MCK/4000) )*us)/1000 )
